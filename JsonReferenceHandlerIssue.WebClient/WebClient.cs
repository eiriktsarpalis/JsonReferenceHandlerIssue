...
namespace JsonReferenceHandlerIssue.WebClient
{
    ...
    public partial class WeatherForecastClient : WebClientBase, IWeatherForecastClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public WeatherForecastClient(JsonReferenceHandlerIssue.WebClient.Interface.IWebClientServiceSettings configuration, System.Net.Http.HttpClient httpClient) : base(configuration)
        {
                ...
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            ...
                            {
                                throw new JsonReferenceHandlerIssueApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        else
                        {
                            ...
                            throw new JsonReferenceHandlerIssueApiException("The HTTP status code of the response was not expected (" + status_ + ").", status_, responseData_, headers_, null);
                        }
                    }
                    finally
                    {
        ...
        protected virtual async System.Threading.Tasks.Task<ObjectResponseResult<T>> ReadObjectResponseAsync<T>(System.Net.Http.HttpResponseMessage response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    throw new JsonReferenceHandlerIssueApiException(message, (int)response.StatusCode, responseText, headers, exception);
                }
            }
            else
            {
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    throw new JsonReferenceHandlerIssueApiException(message, (int)response.StatusCode, string.Empty, headers, exception);
                }
            }
        }
